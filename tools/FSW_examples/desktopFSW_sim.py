...
from FSW_examples import (desktopFSW_models, fsw_plotter)
...
class DesktopFSW(SimulationBaseClass.SimBaseClass):
    def __init__(self):
        ...
        self.fswModels = desktopFSW_models.FSWModels(self)
    ...
    def pull_outputs(self, plots_path=None):
        self.fsw_plotter = fsw_plotter.FSWPlotter(plots_path=plots_path, add_titles=False, name="fsw")
